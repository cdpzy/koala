...
func main() {
	...
	spso := h264.NewSequenceParameterSetRBSP()

	fmt.Println(spso.ParseBytes(sps), spso, spso.VuiParameters)

	ppso := h264.NewPicParameterSetRBSP()
	ppso.ChromaFormatIdc = spso.ChromaFormatIdc
	fmt.Println(ppso.ParseBytes(pps), ppso)
